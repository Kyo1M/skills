...
v2 → v3 → … と iterate する場合、前版から構成を変えると章間整合・縦串・表記揺れが崩れやすい。観点 1・2・3 を最優先で。議論直後の改訂版なら観点 5（議事録マッピング）も必ず通す。
...
- HTML を書き終えたら **Phase 5 のセルフレビュー** を必ず通す。`references/self-review-checklist.md` の 6 観点で点検し、1 項目でも該当があれば修正してから提示する
